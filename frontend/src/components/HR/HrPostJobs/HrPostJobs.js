            ...
            {({ values, errors, touched, handleChange, setFieldValue, handleSubmit, isSubmitting }) => (
              <Form onSubmit={handleSubmit}>
                ...
                <Row className="mb-3">
                  ...
                  <Col>
                    <label style={{color:'#70706e'}} htmlFor="salary">Salary *</label>
                    <Field name="salary" type="text" required className={`form-control ${touched.salary && errors.salary ? 'is-invalid' : ''}`} placeholder="Enter Salary Range" />
