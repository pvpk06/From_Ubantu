...
const SAQuizDash = () => {
    ...
    const handleRenameFolder = async () => {
        try {
            await apiService.put(`/renameFolder/${renameFolder.oldName}`, { newName: renameFolder.newName });
    ...
    const handleRenameSubfolder = async () => {
        try {
            await apiService.put(`/renameSubfolder/${renameSubfolder.folder}/${renameSubfolder.oldName}`, { newName: renameSubfolder.newName });
